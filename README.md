...
│   ├── config/          # SecurityConfig, DataInit
│   ├── controller/      # HomeController, AdminSectionController, ...
│   ├── dto/             # RegisterForm
│   ├── model/           # AppUser, SectionItem, ProjectItem, LabItem, ...
...
Default admin account is created by `DataInit` on first run.
