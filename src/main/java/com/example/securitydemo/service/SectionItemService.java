...
import com.example.securitydemo.model.SectionItem;
import com.example.securitydemo.model.SectionTag;
import com.example.securitydemo.repo.SectionItemRepo;
...
public class SectionItemService {
    ...
    /**
     * 儲存卡片內容 + 同步 tags（clear + re-insert，最多3個）
     */
    @Transactional
